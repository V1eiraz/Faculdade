...
public class XWing extends NaveEspacial implements IHiperdrive {
    ...
    public XWing(String nomePiloto, String nomeDroide) {
        super("X-Wing de " + nomePiloto, 100, 0); // Define energia padrão de 100
        this.droide = new DroideAstromech(nomeDroide);
    }
    ...
    public void saltarParaHiperespaco() {
        System.out.println(getNome() + " entrando no HIperespaço!!");
    }
